...
export default function CardAulasConcluidas({ item }) {
      ...
      <View style={styles.containerProf}>
        ...
        <View style={styles.containerTituloDisciplinaHor}>
          ...
          <View style={{ flexDirection: 'row', marginTop:10, }}>
            <Text style={[styles.txtTitulo, { fontWeight: 'bold', backgroundColor: '#919191', padding: 5, margin: 5, color: '#fff', paddingStart: 10, borderRadius: 15, width: 100, textAlign: 'center' }]}>Nota: {nota}</Text>
            <Text style={[styles.txtTitulo, { fontWeight: 'bold', backgroundColor: 'darkred', padding: 5, margin: 5, color: '#fff', paddingStart: 10, borderRadius: 15, width: 100, textAlign: 'center' }]}>Faltas: 4</Text>

            <TouchableOpacity onPress={() => setOpenModal(!openModal)}>
              <Text style={[styles.txtTitulo, { fontWeight: 'bold', backgroundColor: '#919191', padding: 5, margin: 5, color: '#fff', paddingStart: 10, borderRadius: 15, width: 100, textAlign: 'center' }]}>Ementa</Text>
            </TouchableOpacity>
          </View>
        </View>
