aulaSemestre = [
    { id: 1, nomeDisciplina: "Matemática Discreta", nomeProfessor: "Prof. Carlos Souza", objetivo: "Introduzir conceitos fundamentais de matemática discreta.", ementa: "Conjuntos, funções, relações, lógica, grafos.", criteriosAvaliacao: "Provas, trabalhos e participação.", horario:"17h20" },

    { id: 2, nomeDisciplina: "Programação I", nomeProfessor: "Prof. Ana Lima", objetivo: "Ensinar os conceitos básicos de programação.", ementa: "Variáveis, estruturas de controle, funções, arrays.", criteriosAvaliacao: "Provas práticas e teóricas.", horario:"19h00" },

    { id: 3, nomeDisciplina: "Algoritmos", nomeProfessor: "Prof. João Mendes", objetivo: "Desenvolver o raciocínio lógico para resolver problemas computacionais.", ementa: "Algoritmos, pseudocódigo, estruturas de dados.", criteriosAvaliacao: "Provas e projetos.", horario:"20h50" },

    { id: 4, nomeDisciplina: "Estruturas de Dados", nomeProfessor: "Prof. Maria Clara", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"19h00" },

    { id: 5, nomeDisciplina: "Sistemas de Informação I", nomeProfessor: "Prof. Anna Maria", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"20h50" },

    { id: 6, nomeDisciplina: "Inteligência Artificial", nomeProfessor: "Prof. João Roberto", objetivo: "Desenvolver o raciocínio lógico para resolver problemas computacionais.", ementa: "Algoritmos, pseudocódigo, estruturas de dados.", criteriosAvaliacao: "Provas e projetos.", horario:"17h20" },

    { id: 7, nomeDisciplina: "Banco de Dados I", nomeProfessor: "Prof. Clara Mendes", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"19h00" },

    { id: 8, nomeDisciplina: "Linguagem de Programação", nomeProfessor: "Prof. José Silva", objetivo: "Desenvolver o raciocínio lógico para resolver problemas computacionais.", ementa: "Algoritmos, pseudocódigo, estruturas de dados.", criteriosAvaliacao: "Provas e projetos.", horario:"20h50" },

    { id: 9, nomeDisciplina: "Sistemas Distribuídos", nomeProfessor: "Prof. Maria Clara", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"19h00" },

    { id: 10, nomeDisciplina: "Redes de Computadores", nomeProfessor: "Prof. Maria Clara", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"20h50" },

    { id: 11, nomeDisciplina: "Internet", nomeProfessor: "Prof. Roberto Andrade", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"19h00" },

    { id: 12, nomeDisciplina: "Engenharia de SW", nomeProfessor: "Prof. Lucas Martins", objetivo: "Introduzir conceitos de bancos de dados relacionais.", ementa: "Modelagem de dados, SQL, normalização.", criteriosAvaliacao: "Trabalhos práticos e provas.", horario:"20h50" },
